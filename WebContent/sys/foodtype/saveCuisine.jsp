...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/FoodTypeServlet?method=save" method="post">
				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<input type="text" name="typeName" class="InputStyle" value=""/><span style="color: red"> *</span>
							</td>
						</tr>
					</table>
				</div>
