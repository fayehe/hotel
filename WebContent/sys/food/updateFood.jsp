...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/FoodServlet?method=update&id=${food.id}" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
				...
				<div class="ItemBlock2">
                    ...
                    <tr>
                            ...
                            <select name="foodType_id" style="width:80px">
	                            <c:forEach items="${foodTypes}" var="item" varStatus="varsta">
	                            	<c:choose>
	                            		<c:when test="${item.id == food.foodType_id}"> 
						...
						<tr>
							...
							<td>
								<img name="oldImg" style='max-width:68px;width:68px;width:expression(width>68?"68px":width "px");max-width: 68px;' 
								 src="${pageContext.request.contextPath}/sys/upload/food/${food.img}">
